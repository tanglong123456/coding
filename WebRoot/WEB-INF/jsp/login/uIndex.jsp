...
<div class="width1200 center_yh hidden_yh" style="position: relative;z-index:80;">
    <div class="example2" style="width: 1200px;height: 490px;overflow: hidden;margin-left: 230px;">
        <ul>
            <li><img src="${ctx}/resource/images/a1.jpg" alt=""></li>
            <li><img src="${ctx}/resource/images/a2.jpg" alt=""></li>
            <li><img src="${ctx}/resource/images/a3.jpg" alt=""></li>
            <li><img src="${ctx}/resource/images/a4.jpg" alt=""></li>
        </ul>
    </div>
    <script>
        $(function () {
